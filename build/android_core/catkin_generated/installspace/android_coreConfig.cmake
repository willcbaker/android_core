...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'android_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nasa/android/install/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>, Damon Kohler <damonkohler@google.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nasa/android/install/lib;/home/nasa/rosjava/devel/lib;/opt/ros/hydro/lib)
